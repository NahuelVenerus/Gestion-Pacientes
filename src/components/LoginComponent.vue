        ...
        <div class="col">
            <div class="Login">
                <div class="mb-3">
                    ...
                    <input type="text" v-model="dni" class="form-control" id="exampleFormControlInput1" placeholder="34568498" >
                </div>
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <button type="button" class="btn btn-primary" @click="clickLogin" >Ingresar</button>
                    </div>
